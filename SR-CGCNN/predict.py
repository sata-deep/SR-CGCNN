...
def main():
    ...
    model = CrystalGraphConvNet(orig_atom_fea_len, nbr_fea_len,
                                ...
                                # ****** Modified by Satadeep Bhattacharjee ****
                                conv_mode=getattr(model_args, 'conv_mode',
                                                  'standard'),
                                n_recurrent_steps=getattr(
                                    model_args, 'n_recurrent_steps', None),
                                recurrent_layer_norm=getattr(
                                    model_args, 'recurrent_layer_norm', False),
                                recurrent_learnable_alpha=getattr(
                                    model_args, 'recurrent_learnable_alpha',
                                    False))
    if args.cuda:
        model.cuda()
